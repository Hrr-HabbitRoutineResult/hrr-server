...
public enum ErrorCode implements BaseCode{
    ...
    STATICS_NEGATIVE_VALUE(HttpStatus.BAD_REQUEST, "CHALLENGE40011", "통계 수치는 음수일 수 없습니다."),
    USER_FAVOR_REQUIRED_FIELD_MISSING(HttpStatus.BAD_REQUEST, "CHALLENGE40012", "필수 선호 정보가 누락되었습니다."),
