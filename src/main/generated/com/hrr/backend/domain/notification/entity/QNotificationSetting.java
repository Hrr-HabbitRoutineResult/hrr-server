...
public class QNotificationSetting extends EntityPathBase<NotificationSetting> {
    ...
    private static final long serialVersionUID = 179268384L;
    ...
    public final BooleanPath isBadgeEnabled = createBoolean("isBadgeEnabled");

    public final BooleanPath isChallengeEnabled = createBoolean("isChallengeEnabled");

    public final BooleanPath isFollowEnabled = createBoolean("isFollowEnabled");

    public final BooleanPath isVerificationEnabled = createBoolean("isVerificationEnabled");
