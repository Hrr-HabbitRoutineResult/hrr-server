...
public class QUserChallenge extends EntityPathBase<UserChallenge> {
    ...
    private static final long serialVersionUID = -274037389L;
    ...
    public final NumberPath<Integer> kickWarnings = createNumber("kickWarnings", Integer.class);

    public final EnumPath<com.hrr.backend.domain.user.entity.enums.UserChallengeRole> role = createEnum("role", com.hrr.backend.domain.user.entity.enums.UserChallengeRole.class);

    public final EnumPath<com.hrr.backend.domain.user.entity.enums.ChallengeJoinStatus> status = createEnum("status", com.hrr.backend.domain.user.entity.enums.ChallengeJoinStatus.class);
